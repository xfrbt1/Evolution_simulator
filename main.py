...
if __name__ == '__main__':
    ...
    plots_constructor.data_handler.dictionary(plots_constructor.data_handler.generation_list())
    # print('average reds amount: ', plots_constructor.data_handler.average_reds_amount())
